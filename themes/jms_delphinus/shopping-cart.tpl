			...
			{if !isset($formattedAddresses) || (count($formattedAddresses.invoice) == 0 && count($formattedAddresses.delivery) == 0) || (count($formattedAddresses.invoice.formated) == 0 && count($formattedAddresses.delivery.formated) == 0)}
				{if $delivery->id}
					<div class="col-xs-12 col-sm-6"{if !$have_non_virtual_products} style="display: none;"{/if}>
						<ul id="delivery_address" class="address item address-box">
							<li class="address_title"><h3 class="page-subheading">{l s='Delivery address'}&nbsp;<span class="address_alias">({$delivery->alias})</span></h3></li>
							{if $delivery->company}<li class="address_company"><i class="fa fa fa-check-square-o"></i>{$delivery->company|escape:'html':'UTF-8'}</li>{/if}
							<li class="address_name"><i class="fa fa fa-check-square-o"></i>{$delivery->firstname|escape:'html':'UTF-8'} {$delivery->lastname|escape:'html':'UTF-8'}</li>
							<li class="address_address1"><i class="fa fa fa-check-square-o"></i>{$delivery->address1|escape:'html':'UTF-8'}</li>
							{if $delivery->address2}<li class="address_address2"><i class="fa fa fa-check-square-o"></i>{$delivery->address2|escape:'html':'UTF-8'}</li>{/if}
							<li class="address_city"><i class="fa fa fa-check-square-o"></i>{$delivery->postcode|escape:'html':'UTF-8'} {$delivery->city|escape:'html':'UTF-8'}</li>
							<li class="address_country"><i class="fa fa fa-check-square-o"></i>{$delivery->country|escape:'html':'UTF-8'} {if $delivery_state}({$delivery_state|escape:'html':'UTF-8'}){/if}</li>
						</ul>
					</div>
				{/if}
				{if $invoice->id}
					<div class="col-xs-12 col-sm-6">
						<ul id="invoice_address" class="address alternate_item address-box">
							<li class="address_title"><h3 class="page-subheading">{l s='Invoice address'}&nbsp;<span class="address_alias">({$invoice->alias})</span></h3></li>
							{if $invoice->company}<li class="address_company"><i class="fa fa fa-check-square-o"></i>{$invoice->company|escape:'html':'UTF-8'}</li>{/if}
							<li class="address_name"><i class="fa fa fa-check-square-o"></i>{$invoice->firstname|escape:'html':'UTF-8'} {$invoice->lastname|escape:'html':'UTF-8'}</li>
							<li class="address_address1"><i class="fa fa fa-check-square-o"></i>{$invoice->address1|escape:'html':'UTF-8'}</li>
							{if $invoice->address2}<li class="address_address2"><i class="fa fa fa-check-square-o"></i>{$invoice->address2|escape:'html':'UTF-8'}</li>{/if}
							<li class="address_city"><i class="fa fa fa-check-square-o"></i>{$invoice->postcode|escape:'html':'UTF-8'} {$invoice->city|escape:'html':'UTF-8'}</li>
							<li class="address_country"><i class="fa fa fa-check-square-o"></i>{$invoice->country|escape:'html':'UTF-8'} {if $invoice_state}({$invoice_state|escape:'html':'UTF-8'}){/if}</li>
						</ul>
					</div>
				{/if}
			{else}
				{foreach from=$formattedAddresses key=k item=address}
					<div class="col-xs-12 col-sm-6 address"{if $k == 'delivery' && !$have_non_virtual_products} style="display: none;"{/if}>
						<ul class="{if $address@last}last_item{elseif $address@first}first_item{/if} {if $address@index % 2}alternate_item{else}item{/if} box">
