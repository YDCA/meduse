					...
					<div class="preview">
						...
						{if !$PS_CATALOG_MODE && ($categoryProduct.allow_oosp || $categoryProduct.quantity > 0)}
							<div class="action">
								...
								<a class="product-btn cart-button btn-default active ajax_add_to_cart_button" href="{$product.link|escape:'html'}" data-id-product="{$categoryProduct.id_product|intval}" title="{l s='Add to cart' mod='productscategory'}">
