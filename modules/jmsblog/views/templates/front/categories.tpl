...
{if isset($categories) AND $categories}		
	<div class="categories-list row">
		{foreach from=$categories item=category}			
			{assign var=catparams value=['category_id' => $category.category_id, 'slug' => $category.alias|replace:'-':'_'|replace:' ':'_']}				
			<div class="col-sm-4 col-md-4 col-lg-4">
				<div class="blog-category">
					...
					<div class="category-info">
						<h4 class="post-title"><a href="{jmsblog::getPageLink('jmsblog-category', $catparams)|escape:'htmlall':'UTF-8'}">{$category.title|escape:'htmlall':'UTF-8'}</a></h4>	
