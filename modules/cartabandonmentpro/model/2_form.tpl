...
<div id="color_2_1_1" width="600" align="center" valign="top" style="background-color:#FFFFFF;">
    <input id="color_picker_2_1_1" class="color" name="color_picker_2_1_1" value="FFFFFF" />
    ...
    <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr><td id="color_2_2_1" bgcolor="#FFFFFF">
            <input id="color_picker_2_2_1" class="color" name="color_picker_2_2_1" value="FFFFFF" />
            <table width="600" border="0" cellpadding="0" cellspacing="0">
                <tbody>
                    <tr>
