...
<div id="color_2_1_3" width="600" align="center" valign="top" style="background-color:#FFFFFF;">
    <input id="color_picker_2_1_3" class="color" name="color_picker_2_1_3" value="FFFFFF" />
    ...
    <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr><td id="color_2_2_3" bgcolor="#FFFFFF">
            <input id="color_picker_2_2_3" class="color" name="color_picker_2_2_3" value="FFFFFF" />
            <table width="600" border="0" cellpadding="0" cellspacing="0">
                <tbody>
                    <tr>
