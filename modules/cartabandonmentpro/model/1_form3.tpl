...
<div id="color_1_1_3" align="center" style="background-color:#2A374E;"><center>
                <input id="color_picker_1_1_3" class="color" name="color_picker_1_1_3" value="2A374E" />
                    ...
                    <tbody>
                        ...
                        <tr class="pagetoplogo">
                            <td id="color_1_2_3" bgcolor="#F2F0F0">
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tbody>
                                        <tr><td colspan="3"><input id="color_picker_1_2_3" class="color" name="color_picker_1_2_3" value="F2F0F0" /></td></tr>
                                        <tr>
                        ...
                        <tr class="content">
                            <td id="color_1_3_3" class="w640" class="w640"  width="640" bgcolor="#ffffff">
                                <input id="color_picker_1_3_3" class="color" name="color_picker_1_3_3" value="ffffff" />
                        ...
                        <tr class="pagebottom">
                            <td id="color_1_4_3" class="w640"  width="640" bgcolor="#c7c7c7">
                                <table class="w640"  width="640" cellpadding="0" cellspacing="0" border="0" >
                                    <tbody>
                                        <tr><td colspan=3><input id="color_picker_1_4_3" class="color" name="color_picker_1_4_3" value="c7c7c7" /></td></tr>
                                        <tr>
