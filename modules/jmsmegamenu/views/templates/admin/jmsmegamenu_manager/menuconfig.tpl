...
*}
<form action="{$link->getAdminLink('AdminJmsmegamenuManager')|escape:'htmlall':'UTF-8'}&configure=jmsmegamenu" method="post">
...
<ul>
    <li>
		...
		<fieldset class="btn-group">
		<input type="text" name="JMSMM_DURATION" value="{$JMSMM_DURATION|escape:'htmlall':'UTF-8'}" id="open-speed" />
		</fieldset>
	</li>
</ul>
<ul>
