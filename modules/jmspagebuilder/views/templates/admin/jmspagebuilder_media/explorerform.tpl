...
<div class="explorer-form">		
	<div class="col-sm-12 row">						
		<div class="media-form path-form">
			<i class="icon-folder-open"></i> {l s='Path' mod='jmspagebuilder'} : {if $root_folder}{$root_folder|escape:'htmlall':'UTF-8'}{/if}{$current_folder|escape:'htmlall':'UTF-8'}			
		...
		<div class="media-form upload-form">			
			...
			<button name="submitImage" id="upload-file" class="btn btn-success">{l s='Upload File' mod='jmspagebuilder'}</button> <span>({l s='Maximum Size' mod='jmspagebuilder'}: {ini_get('upload_max_filesize')|escape:'htmlall':'UTF-8'}B)</span>
		</div>
	</div>
</div>
