...
<div class="jms-blog-nav">
	<ul class="jms-blog-menu">
		<li class="{if  $view == 'items'}active{/if}"><a href="{$link->getAdminLink('AdminModules')|escape:'htmlall':'UTF-8'}&configure=jmstestimonials&view=items">Items</a></li>
		<li class="{if  $view == 'config'}active{/if}"><a href="{$link->getAdminLink('AdminModules')|escape:'htmlall':'UTF-8'}&configure=jmstestimonials&view=config">Config</a></li>
	</ul>
</div>