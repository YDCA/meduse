		...
		<div class="row">
			<div class="translatable-field " >
				<div class="col-lg-6">
					...
					<img src="{$image_baseurl|escape:'htmlall':'UTF-8'}{$fields[0]['form']['images']|escape:'htmlall':'UTF-8'}" class="img-thumbnail" />
					<input type="hidden" name="image_old" value="{$fields[0]['form']['images']|escape:'htmlall':'UTF-8'}" />
					{/if}
					...
					<div class="dummyfile input-group">
						...
						<span class="input-group-btn">
							<button id="{$input.name|escape:'htmlall':'UTF-8'}-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
								<i class="icon-folder-open"></i> {l s='Choose a file' mod='jmstestimonials'}
							</button>
						</span>
					</div>
				</div>
