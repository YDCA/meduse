...
/*JS Lint helpers: */
/*global dragMove: false, dragEnd: false, $csocjqPm, jQuery, alert, window, document */
...
(function ($csocjqPm, window, document) {
    ...
    var Carousel = {
        ...
        logIn : function () {
            ...
            base.$elem.data("pm-csoc-owl-originalStyles", base.$elem.attr("style"))
                      .data("pm-csoc-owl-originalClasses", base.$elem.attr("class"));
        ...
        eventTypes : function () {
            ...
            if (base.options.mouseDrag === true && base.options.touchDrag === true) {
                types = [
                    "touchstart.pmCSOCOwl mousedown.pmCSOCOwl",
                    "touchmove.pmCSOCOwl mousemove.pmCSOCOwl",
                    "touchend.pmCSOCOwl touchcancel.pmCSOCOwl mouseup.pmCSOCOwl"
                ];
            } else if (base.options.mouseDrag === false && base.options.touchDrag === true) {
                types = [
                    "touchstart.pmCSOCOwl",
                    "touchmove.pmCSOCOwl",
                    "touchend.pmCSOCOwl touchcancel.pmCSOCOwl"
                ];
        ...
        disabledEvents :  function () {
            var base = this;
            base.$elem.on("dragstart.pmCSOCOwl", function (event) { event.preventDefault(); });
        ...
        unWrap : function () {
            ...
            base.clearEvents();
            base.$elem
                .attr("style", base.$elem.data("pm-csoc-owl-originalStyles") || "")
                .attr("class", base.$elem.data("pm-csoc-owl-originalClasses"));
        },
