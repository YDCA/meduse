			...
			{foreach from=$languages item=language}
				...
				{/if}
					<div class="col-lg-6">
						...
						<img src="{$image_baseurl|escape:'htmlall':'UTF-8'}{$fields[0]['form']['simages'][$language.id_lang]|escape:'htmlall':'UTF-8'}" class="img-thumbnail" />
						<input type="hidden" name="simage_old_{$language.id_lang|escape:'htmlall':'UTF-8'}" value="{$fields[0]['form']['simages'][$language.id_lang]|escape:'htmlall':'UTF-8'}" />
						{/if}
						...
						<div class="dummyfile input-group">
							...
							<span class="input-group-btn">
								<button id="{$input.name|escape:'htmlall':'UTF-8'}_{$language.id_lang|escape:'htmlall':'UTF-8'}-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
									<i class="icon-folder-open"></i> {l s='Choose a file'  mod='jmsbrands'}
								</button>
							</span>
						</div>
					</div>
