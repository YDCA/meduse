...
{if $cartDatesDelivery|count}
	...
	<div id="advanceddateofdelivery" class="advanced_box">
...
<script type="text/javascript">
	jQuery(document).ready(function ($) {
		$('.delivery_options_address, table#carrierTable, .delivery-options-list .delivery-options').nextAll('#advanceddateofdelivery').remove();
