...
{block name="field"}
	{if $input.type == 'product_search'}		
		<div class="input-group search-product-input">
			<input type="text" id="product" value="{if isset($fields_value.product_name)}{$fields_value.product_name|escape:'htmlall':'UTF-8'}{/if}" />
			<input type="hidden" id="id_product" name="id_product" value="{if isset($fields_value.id_product)}{$fields_value.id_product|escape:'htmlall':'UTF-8'}{/if}" />
