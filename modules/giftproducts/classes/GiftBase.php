...
class GiftBase
{
    ...
    public static function getGiftProductsByProducts($id_lang, $ids_products, $id_cart)
    {
        ...
        $gift_products = GiftProduct::getGiftProductsByProducts($id_lang, $ids_products, $id_cart);
        ...
        $categories_gift_products = GiftCategory::getGiftProductsByCategories($id_lang, $product_categories, $id_cart);
    ...
    public static function getGiftProductsByProduct($id_product)
    {
