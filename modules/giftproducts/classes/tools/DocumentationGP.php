...
class DocumentationGP
{
    public static function assignDocumentation()
    {
        ...
        HelperModuleGP::addCSS('documentation.css');
        $documentation_folder = _PS_MODULE_DIR_.ToolsModuleGP::getModNameForPath(__FILE__)
            .'/views/templates/admin/documentation';
        $documentation_pages = ToolsModuleGP::globRecursive($documentation_folder.'/**.tpl');
