...
class ModuleAdminControllerGP extends ModuleAdminController
{
    /**
    ...
    */
    ...
    public function __construct()
    {
        ...
        */
        ...
        ToolsModuleGP::globalAssignVar();
        ToolsModuleGP::convertJSONRequestToPost();
    }
    ...
    public function assignModuleTabAdminLink()
    {
        $this->context->smarty->assign(
            ...
            HelperModuleGP::getModuleTabAdminLink()
        );
    }
    ...
    public function renderList()
    {
        if ($this->module->documentation) {
            ...
            return ToolsModuleGP::fetchTemplate(
    ...
    {
        ToolsModuleGP::autoloadCSS($this->module->getPathUri().'views/css/autoload/');
    ...
    {
        ErrorHandlerGP::setErrorHandler();
        HelperModuleGP::createAjaxApiCall($this);
    }
    ...
    protected function assignAngularFiles()
    {
        ...
        $angular_templates = ToolsModuleGP::globRecursive($angular_templates_folder.'/**.tpl');
    ...
    public function processSave()
    {
        ...
        if (Validate::isLoadedObject($object)
            ...
            if (property_exists($object_name, $property) && $object_name::$$property) {
                foreach (ToolsModuleGP::getLanguages(false) as $l) {
                    $image = Tools::fileAttachment('image_'.$l['id_lang']);
                    if ($image['tmp_name'] && ToolsModuleGP::checkImage($image['tmp_name'])) {
