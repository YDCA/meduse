...
class FormatConfGP
{
            ...
            foreach ($input_array as $item) {
                ...
                foreach ($properties as $property => $value) {
                    if (is_array($post_data) && array_key_exists($item[$id_key], $post_data)
                        ...
                        $return_data[$item[$id_key]][$property] = ToolsModuleGP::formatValue(
    ...
    {
        return self::prepareSettingGroup(ConfGP::getConf('SETTING_GROUPS', ConfGP::TYPE_ARRAY));
    }

    public static function getSettingOrderStates()
    {
        return self::prepareSettingOrderStates(ConfGP::getConf('SETTING_ORDER_STATES', ConfGP::TYPE_ARRAY));
    }
}
