...
{if isset($view_header) && $view_header && isset($root) && $root}
	<div class="tree_categories_header">
		<a class="collapse_all btn btn-default" href="#" style="display: none;">
			<i class="icon-collapse-alt"></i>
			{l s='Collapse all' mod='giftproducts'}
		</a>
		<a class="expand_all btn btn-default" href="#">
			<i class="icon-expand-alt"></i>
			{l s='Expand all' mod='giftproducts'}
		</a>
		<a class="check_all_associated_categories btn btn-default" href="#">
			<i class="icon-check-sign"></i>
			{l s='Check all' mod='giftproducts'}
		</a>
		<a class="uncheck_all_associated_categories btn btn-default" href="#">
			<i class="icon-check-empty"></i>
			{l s='Uncheck all' mod='giftproducts'}
		</a>
